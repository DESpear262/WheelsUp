...
# RDS Snapshot Creation (Manual/On-Demand)
...
# S3 Backup Bucket for Cross-Region Replication (Optional)
...
# ============================================================================
# AWS Backup Service (Advanced Backup Management)
# ============================================================================
...
# Additional policy for RDS backup permissions
